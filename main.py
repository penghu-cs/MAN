...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=100) # 256
    parser.add_argument('--lr', type=float, default=2e-4)
    # parser.add_argument('--lr', type=float, default=1e-3)
    parser.add_argument('--output_shape', type=int, default=-1)
    parser.add_argument('--eta', type=float, default=1e-3)
    parser.add_argument('--datasets', type=str, default='pascal') # wiki, pascal, reuters, xmedia, xmedia_pairwise
